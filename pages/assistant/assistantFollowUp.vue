				...
				<view class="list-item" v-for="(item,index) in followList" :key="index">
					...
					<view class="" @tap="pageTo('/pages/assistant/assistantPage/assistantHudongGuanli')">
						...
						<view class="real-name-tell">
							<text class="txt_marks">"</text> {{item.dcse}} <text class="txt_marks">"</text>
						</view>
						<view class="lins"></view>
						...
						<view class="activity">
							<view class="activity-img">
								<image :src="item.activity_img" mode="scaleToFill"></image>
							</view>
							<view class="activity-info">
								...
								<view class="activity-dcse">
									...
									<text><text style="margin-right: 4upx;">开始于</text> {{item.activity_time}}</text>
								</view>
						...
						<view class="status-list">
							...
							<view class="order_status">
								<image class="order_img" src="/static/assistant/jilu.png"></image> <text>互动管理</text>
							</view>
						</view>
					</view>
				</view>
	...
	export default {
		...
		onLoad: function () {
			...
			// setTimeout(()=>{
				...
				// ];
				// this.filterData = dataList.filterData; 
