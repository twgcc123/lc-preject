<template>
	<view class="dramblill">
		<view class="order-item"><roomOrderItem></roomOrderItem></view>
		<view class="blill-detail">
			...
			<view class="blill-list">
				...
				<view class="content-list" v-for="(item, index) in blillItem" :key="item.id">
					...
					<!-- <input class="lcon" v-model="item.name" :disabled="activeIndex === index"/> -->
					<input class="lcon" v-model="item.content" :disabled="activeIndex === index" />
				</view>
				<view class="content-list">
					<view class="lname">更多内容</view>
					<view class="lname-other" @tap="pageTo('/pages/found/youju/roomOrderDrawBillEdit')">
						填写备注、地址等（非必填）
			...
			<view class="blill-way">
				...
				<view class="email">
					...
					<view class="eemai"><input class="lcon" v-model="emai" /></view>
				</view>
			</view>
		...
		<view class="blill-btn" @tap="pageTo('/pages/mine/mainPage/mineFaPiao')">提交</view>
	</view>
</template>
