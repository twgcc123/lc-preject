		...
		<view class="list">
			<view class="list-item" v-for="(item, index) in signList" :key="index">
				<view class="list-item-top">
					...
					<view class="list-item-top-right" @click="openPopup"><image class="list-item-top-right-dot" src="/static/dongtai/dot_black.svg"></image></view>
				</view>
				<view class="list-item-sign"><heart-sign :sign="item.sign" marginTop="26rpx" width="430rpx" height="680rpx" type="2"></heart-sign></view>
				...
				<view class="list-item-bottom-bar">
					...
					<view class="list-item-bottom-bar-right">
						...
						<view class="list-item-bottom-bar-right-imgbox"><image src="/static/dongtai/comment_block.svg"></image></view>
					</view>
				</view>
			...
			<uni-popup ref="popup1" type="bottom">
				<view class="popup">
					...
					<view class="popup-item bottom-line" @tap="closePopup">删除</view>
					<view class="popup-item bottom-line" @tap="closePopup">修改</view>
