	...
	<view>
		<view class="order-time" v-if="!modal">
			...
			<view class="time-viewer" v-else>
				...
				<text class="sumCount"> <text class="sumCount-yuans"></text> {{ dayCount2 }}</text>
				<view @tap="showCalendar()" class="choose-time">选择日期 <text class="icons-time"></text></view>
			</view>
		</view>
