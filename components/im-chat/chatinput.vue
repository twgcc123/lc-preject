<template>
	<view class="footer">
		...
		<view class="footer-center">
			<input class="input-text" @keyboardheightchange="keyboardHeightChange" type="text" @confirm="sendMessge" v-model="inputValue" :focus="focus" @blur="blur" :placeholder="placeholder"></input>
		</view>
